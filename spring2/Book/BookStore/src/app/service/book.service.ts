...
export class BookService {
  ...
  delete(id: number) {
    return this.http.delete<BookDto>(`${API_URL}/books/${id}`);
  }
  update(id: number, bookDto:BookDto ): Observable<BookDto | any> {
    return this.http.patch(`${API_URL}/books/${id}`, bookDto);
  }
}

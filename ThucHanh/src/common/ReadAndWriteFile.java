...
public class ReadAndWriteFile {
    ...
    public static void readFilerCoThoiHan(List<SoTietKiemCoThoiHan> list) {
        try {
            FileReader fileReader = new FileReader("src/data/coThoiHan.csv");
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String line;
            while ((line = bufferedReader.readLine()) != null) {
                String[] temp = line.split(",");
                SoTietKiemCoThoiHan soTietKiemCoThoiHan = new SoTietKiemCoThoiHan(temp[0], Integer.parseInt(temp[1]), temp[2], temp[3], temp[4], temp[5], temp[6]);
    ...
    public static void readFilerDaiHan(List<SoTietKiemDaiHan> list) {
        try {
            FileReader fileReader = new FileReader("src/data/daiHan.csv");
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String line;
            while ((line = bufferedReader.readLine()) != null) {
                String[] temp = line.split(",");
                SoTietKiemDaiHan soTietKiemDaiHan = new SoTietKiemDaiHan(temp[0], Integer.parseInt(temp[1]), temp[2], temp[3], temp[4], temp[5], temp[6],temp[7]);
    ...
    public static void readFilerVoThoiHan(List<SoTietKiemVoThoiHan> list) {
        try {
            FileReader fileReader = new FileReader("src/data/voThoiHan.csv");
            BufferedReader bufferedReader = new BufferedReader(fileReader);
            String line;
            while ((line = bufferedReader.readLine()) != null) {
                String[] temp = line.split(",");
                SoTietKiemVoThoiHan soTietKiemVoThoiHan = new SoTietKiemVoThoiHan(temp[0], Integer.parseInt(temp[1]), temp[2], temp[3], temp[4],temp[5]);
    ...
    public static void writeFileVoThoiHan(List<SoTietKiemVoThoiHan> lists) {
        List<String> list = new ArrayList<>();
        for (SoTietKiemVoThoiHan e : lists) {
            list.add(e.covertoString());
        }
        writeFile(list, "src/data/voThoiHan.csv");
    }
    public static void writeFileCoThoiHan(List<SoTietKiemCoThoiHan> lists) {
        List<String> list = new ArrayList<>();
        for (SoTietKiemCoThoiHan e : lists) {
            list.add(e.covertoString());
        }
        writeFile(list, "src/data/coThoiHan.csv");
    }
    public static void writeFileDaiHan(List<SoTietKiemDaiHan> lists) {
        List<String> list = new ArrayList<>();
        for (SoTietKiemDaiHan e : lists) {
            list.add(e.covertoString());
        }
        writeFile(list, "src/data/daiHan.csv");
    }
...
//        try (FileReader fileReader = new FileReader("src/furama_resort/data/facility/villa.csv");
//             BufferedReader bufferedReader = new BufferedReader(fileReader)) {
//            String line;
//            while ((line = bufferedReader.readLine()) != null) {
//                String[] temp = line.split(",");
...
//            e.printStackTrace();
//        }
//        try (FileReader fileReader = new FileReader("src/furama_resort/data/facility/room.csv");
//             BufferedReader bufferedReader = new BufferedReader(fileReader)) {
//            String line;
//            while ((line = bufferedReader.readLine()) != null) {
//                String[] temp = line.split(",");
...
//            e.printStackTrace();
//        }
//        try (FileReader fileReader = new FileReader("src/furama_resort/data/facility/house.csv");
//             BufferedReader bufferedReader = new BufferedReader(fileReader)) {
//            String line;
//            while ((line = bufferedReader.readLine()) != null) {
//                String[] temp = line.split(",");

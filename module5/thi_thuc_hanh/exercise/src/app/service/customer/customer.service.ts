...
export class CustomerService {
  ...
  //   return this.http.get<Customer[]>(this.URL_API + `/?name_like=${value}`  + `/?customerType_like=${value}`);
    // return this.http.get<Customer[]>(`${SERVICE_URL}/customers/search?nameCustomer=${nameCustomer}&customerTypeId=${customerTypeId}`);
  // }

// + value + '/?customerType_like=' + value

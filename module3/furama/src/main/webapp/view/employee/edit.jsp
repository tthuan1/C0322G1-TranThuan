    ...
    <div class="container">
        <div class="row">
            <form method="post">
                ...
                <div class="form-floating mb-3 mt-3">
                    <select class="form-select" id="sel1" name="divisionId">
                        <c:if test="${employee.id == employeeDTO.id}">
                            <option value="${employee.divisionId}" selected>
                                old choice: ${employeeDTO.divisionName}
                            </option>
                        </c:if>
                ...
                <div class="form-floating mb-3 mt-3">
                    <select class="form-select" id="sel2" name="positionId">
                        <c:if test="${employee.id == employeeDTO.id}">
                            <option value="${employee.positionId}" selected>
                                old choice: ${employeeDTO.positionName}
                            </option>
                        </c:if>
                    ...
                    <label for="sel2" class="form-label">Select position (select one):</label>
                </div>


                <div class="form-floating mb-3 mt-3 ">
                    <select class="form-select" id="sel3" name="educationDegreeId">
                        <c:if test="${employee.id == employeeDTO.id}">
                            <option value="${employee.educationDegreeId}" selected>
                                old choice: ${employeeDTO.educationDegreeName}
                            </option>
                        </c:if>
                    ...
                    <label for="sel3" class="form-label">Select educationDegree (select one):</label>
                </div>
